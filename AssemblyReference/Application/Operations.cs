...
namespace Application;
{
    ...
    public static class Operations
    {
        ...
        public static void DefaultData(){
            StudentDetails student1 = new StudentDetails("Rishi", "Padhu", new DateOnly(2001,01,21),Gender.Male,98,89,78);
            StudentDetails student2 = new StudentDetails("Paru", "Raj Kumar", new DateOnly(2000,12,26),Gender.Female,100,89,98);
